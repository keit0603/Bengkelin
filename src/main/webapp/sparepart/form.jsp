...
<head>
    ...
    <title>${not empty sparePart.kodePart ? 'Edit' : 'Tambah'} Spare Part - Bengkelin</title>
        ...
        <div id="main-content">
            <header class="topbar d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                    ...
                    <h4 class="mb-0 fw-bold d-none d-sm-block">Formulir Spare Part</h4>
                </div>
                 <div class="d-flex align-items-center">
                    <div class="dropdown">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">${not empty sparePart.kodePart ? 'Edit Data' : 'Tambah Baru'}</li>
                </ol>
            </nav>
            ...
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white p-3">
                    <h5 class="mb-0">
                        <i class="fas ${not empty sparePart.kodePart ? 'fa-edit' : 'fa-plus-circle'} me-2 text-primary"></i>
                        ${not empty sparePart.kodePart ? 'Edit Data Spare Part' : 'Form Spare Part Baru'}
                    </h5>
                </div>
                <div class="card-body p-4">
                    <form action="${formActionUrl}" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="kodePart" name="kodePart"
                                   value="<c:out value='${sparePart.kodePart}' />"
                                   ${not empty sparePart.kodePart ? 'readonly' : 'required'}>
                            <c:if test="${not empty sparePart.kodePart}">
                                <div class="form-text">Kode Part tidak dapat diubah.</div>
                            </c:if>
                        </div>

                        <div class="mb-3">
                            <label for="nama" class="form-label">Nama Spare Part</label>
                            <input type="text" class="form-control" id="nama" name="nama" value="<c:out value='${sparePart.nama}' />" required>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" class="form-control" id="harga" name="harga" step="100" min="0" value="<c:out value='${sparePart.harga}' />" required>
                                </div>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="stok" class="form-label">Stok</label>
                                <input type="number" class="form-control" id="stok" name="stok" min="0" value="<c:out value='${sparePart.stok}' />" required>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-end">
                             <a href="${pageContext.request.contextPath}/sparepart?action=list" class="btn btn-secondary me-2">Batal</a>

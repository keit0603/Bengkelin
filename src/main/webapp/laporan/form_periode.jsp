...
<head>
    ...
    <title>Laporan Transaksi per Periode - Bengkelin</title>
        ...
        <div id="main-content">
            <header class="topbar d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                    ...
                    <h4 class="mb-0 fw-bold d-none d-sm-block">Laporan per Periode</h4>
                </div>
                 <div class="d-flex align-items-center">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Laporan per Periode</li>
                </ol>
            </nav>
                ...
                <div class="col-lg-8">
                    <div class="card shadow-sm border-0">
                        <div class="card-header bg-white p-3">
                            <h5 class="mb-0"><i class="fas fa-calendar-alt me-2 text-primary"></i>Pilih Rentang Tanggal</h5>
                        </div>
                        <div class="card-body p-4">
                            <p class="text-muted">Pilih tanggal mulai dan tanggal akhir untuk menghasilkan laporan transaksi.</p>
                            <form action="${pageContext.request.contextPath}/laporan?action=hasilPeriode" method="post">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                        <label for="startDate" class="form-label">Tanggal Mulai</label>
                                        <input type="date" class="form-control" id="startDate" name="startDate" value="${defaultStartDate}" required>
                                    </div>
                                    <div class="col-md-6">
                                        <label for="endDate" class="form-label">Tanggal Akhir</label>
                                        <input type="date" class="form-control" id="endDate" name="endDate" value="${defaultEndDate}" required>
                                    </div>
                                </div>
                                <hr class="my-4">
                                <div class="d-flex justify-content-end">
                                    <a href="${pageContext.request.contextPath}/laporan?action=menu" class="btn btn-secondary me-2">Kembali</a>
                                    <button type="submit" class="btn btn-primary"><i class="fas fa-file-alt me-2"></i>Tampilkan Laporan</button>
                                </div>
                            </form>
                        </div>
                    </div>

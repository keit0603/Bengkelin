...
<head>
    ...
    <title>Laporan per Spare Part - Bengkelin</title>
...
<div id="page-container">
        ...
        <div id="main-content">
            <header class="topbar d-flex align-items-center justify-content-between mb-4">
                <div class="d-flex align-items-center">
                    ...
                    <h4 class="mb-0 fw-bold d-none d-sm-block">Laporan per Spare Part</h4>
                </div>
                 <div class="d-flex align-items-center">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Laporan per Spare Part</li>
                </ol>
            </nav>
                ...
                <div class="col-lg-8">
                    <div class="card shadow-sm border-0">
                        <div class="card-header bg-white p-3">
                            <h5 class="mb-0"><i class="fas fa-search me-2 text-primary"></i>Pilih Spare Part</h5>
                        </div>
                        <div class="card-body p-4">
                            <p class="text-muted">Pilih satu spare part untuk melihat daftar pelanggan yang pernah menggunakannya.</p>
                            <form action="${pageContext.request.contextPath}/laporan" method="post">
                                <input type="hidden" name="action" value="hasilSparePart">
                                <div class="mb-3">
                                    <label for="kodePart" class="form-label">Spare Part</label>
                                    <select class="form-select" id="kodePart" name="kodePart" required>
                                        <option></option>
    ...
    <script>
        $(document).ready(function() {
            $('#kodePart').select2({
                placeholder: "-- Cari dan Pilih Spare Part --",
                theme: "bootstrap-5"
            });
